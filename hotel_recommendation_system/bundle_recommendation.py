...
file_path = os.path.join(os.path.dirname(__file__), 'toy_bundle_recommenders.pkl')
# file_path = "/home/ankhanh/work/frappe/frappe-bench/apps/hotel_recommendation_system/hotel_recommendation_system/toy_bundle_recommenders.pkl"
bundle_recommender = pickle.load(open(file_path,'rb'), encoding='utf-8')
# with open('/home/ankhanh/work/frappe/frappe-bench/apps/hotel_recommendation_system/hotel_recommendation_system/toy_bundle_recommenders.pkl', 'rb') as f:
#     toy_bundle_recommenders = pickle.load(f)
# bundle_recommender = toy_bundle_recommenders
